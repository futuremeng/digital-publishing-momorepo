 ...
 * @LastEditTime: 2025-06-20 15:10:58
 * @FilePath: /one-monorepo/packages/store/vite.config.ts
 * @Description:
...
export default defineConfig({
  resolve: {
    alias: [
      {
        find: /\@jiulu\/utils/,
        replacement: `${pathResolve("../../../packages/utils")}/`,
      },
      // @jiulu/types
      {
        find: /\@jiulu\/types/,
      ...
      {
        find: /\@jiulu\/enums/,
        replacement: `${pathResolve("../../../packages/enums")}/`,
      }
    ],
  },
})
