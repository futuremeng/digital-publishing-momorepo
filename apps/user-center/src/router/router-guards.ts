 ...
 * @LastEditTime: 2025-06-20 11:15:48
 * @FilePath: /one-monorepo/apps/user-center/src/router/router-guards.ts
 * @Description:
...
const whitePathList = [LOGIN_PATH, PageEnum.WEIXIN_LOGIN, PageEnum.WEIXIN_LOGIN_CALLBACK] // no redirect whitelist
