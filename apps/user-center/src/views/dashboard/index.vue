 ...
 * @LastEditTime: 2025-06-20 20:32:02
 * @FilePath: /one-monorepo/apps/user-center/src/views/dashboard/index.vue
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
-->
<template>
  <div class="h-screen flex flex-col items-center justify-center">
    <div class="wel-box w-full flex flex-col items-center justify-between p-60px">
      ...
      <!-- <RemoteComponent :dsl="{package:'one-basic',component:'RemoteCounter'}"></RemoteComponent> -->
    </div>
    <van-grid :column-num="3" class="w-full">
      <van-grid-item icon="photo-o" text="听写" @click="navigateToApp('dictation')" />
      <van-grid-item icon="photo-o" text="词典" @click="navigateToApp('dictionary')" />
...
import { navigateToApp } from "@jiulu/utils";
