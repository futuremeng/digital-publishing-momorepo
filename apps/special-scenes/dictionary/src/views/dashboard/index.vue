 ...
 * @LastEditTime: 2025-06-23 11:33:05
 * @FilePath: /one-monorepo/apps/special-scenes/dictionary/src/views/dashboard/index.vue
...
<template>
  <div class="h-screen flex flex-col items-center justify-center p-60px">
    <div class="wel-box w-full flex flex-col items-center justify-between">
      ...
      <div class="i-fluent-search-sparkle-28-filled" />
      <n-button>naive-ui</n-button>
      <van-icon name="arrow-left" />
      <van-button icon="arrow-left">默认按钮</van-button>
