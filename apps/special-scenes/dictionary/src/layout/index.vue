 ...
 * @LastEditTime: 2025-06-23 12:47:43
 * @FilePath: /one-monorepo/apps/special-scenes/dictionary/src/layout/index.vue
 * @Description: 
...
<template>
  <div class="h-screen flex flex-col">
    ...
    <van-tabbar route class="tabbar">
      ...
      >
        <template #icon>
          <!-- <i :class="menu.meta?.icon" /> 默认不会加载 icon-->
          <div :class="menu.meta?.icon"></div>
        </template>
        {{ menu.meta?.title }}
      </van-tabbar-item>
    </van-tabbar>
